...
export const themeConfigs: ThemePalette[] = [
  ...
  },
  {
    ...
    base: {
      ...
      backgroundLighter: "#101010",
      foregroundMuted: "#CCCCCC",
      foregroundVeryMuted: "#AAAAAA",
      shadowColor: "#000000",
    },
    green: {
      keywordBold: "#00FF00",       // Bright greens for max contrast
      functionMoss: "#00EE00",
      leafLight: "#00DD00",
      successLight: "#00EE00",
      statusGood: "#00DD00",
    ...
    teal: {
      ...
      operatorSage: "#00CCEE",
      namespace: "#00DDFF",
      structureCalm: "#00BBDD",
    },
    ochre: {
      warmBold: "#FFCC00",
      constantMuted: "#EEBB00",
      warningAmber: "#FFCC00",
      autumnRust: "#FF9900",
    },
    red: {
      errorClay: "#FF0000",         // Bright saturated red for errors
      errorLight: "#FF4444",
      rust: "#EE0000",
    ...
    brown: {
      htmlEarthy: "#FFCC00",
      attributeMuted: "#DDAA00",
      tagPunctuation: "#CCAA00",
    },
    gray: {
      commentMuted: "#888888",
      lineNumberMuted: "#666666",
      lineNumberActive: "#BBBBBB",
      tan: "#FFFFFF",
      tanMuted: "#CCCCCC",
      veryMuted: "#888888",
    },
    ui: {
      selectionBackground: "#224466",
      selectionInactive: "#1A1A1A",
      selectionHighlight: "#223344",
      wordHighlight: "#202020",
      wordHighlightStrong: "#303030",
      findMatch: "#FFFF00",
      findMatchHighlight: "#AAAA00",
